...
#create a variable that will drop unsued columns and  convert the data to a numpy array
    new_data =df.drop([0, 11, 12, 13]).values.reshape(1,-1)
...
def main():
        ...
        REGION = st.selectbox("Please select your region", ('FATICK', 'nan', 'DAKAR', 'LOUGA', 'TAMBACOUNDA', 'KAOLACK', 'THIES',
     'SAINT-LOUIS', 'KOLDA', 'KAFFRINE', 'DIOURBEL', 'ZIGUINCHOR','MATAM', 'SEDHIOU', 'KEDOUGOU'))
        ...
        TOP_PACK = st.selectbox("Please enter your most active packs", ('On net 200F=Unlimited _call24H', 'nan, ''On-net 1000F=10MilF;10d',
